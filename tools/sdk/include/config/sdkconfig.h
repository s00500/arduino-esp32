...
#define CONFIG_ESP32_RTC_EXTERNAL_CRYSTAL_ADDITIONAL_CURRENT 1
...
#define CONFIG_PARTITION_TABLE_FILENAME "semina_debug.csv"
...
#define CONFIG_PARTITION_TABLE_CUSTOM_FILENAME "semina_debug.csv"
